...
PATTERNS = {
    "train": "https://raw.githubusercontent.com/xliuhw/NLU-Evaluation-Data/master/CrossValidation/autoGeneFromRealAnno/autoGene_2018_03_22-13_01_25_169/CrossValidation/KFold_1/trainset/{f}",
    "test": "https://raw.githubusercontent.com/xliuhw/NLU-Evaluation-Data/master/CrossValidation/autoGeneFromRealAnno/autoGene_2018_03_22-13_01_25_169/CrossValidation/KFold_1/testset/csv/{f}"
}
PATTERNS = {
    #dialoglue/data_utils/intent_scripts/
    "train": "NLU-Evaluation-Data-master/CrossValidation/autoGeneFromRealAnno/autoGene_2018_03_22-13_01_25_169/CrossValidation/KFold_1/trainset/{f}",
    #"train": "dialoglue/data_utils/intent_scripts/NLU-Evaluation-Data-master/CrossValidation/autoGeneFromRealAnno/autoGene_2018_03_22-13_01_25_169/CrossValidation/KFold_1/trainset/{f}",
    "test": "NLU-Evaluation-Data-master/CrossValidation/autoGeneFromRealAnno/autoGene_2018_03_22-13_01_25_169/CrossValidation/KFold_1/testset/csv/{f}"
}
...
def _get_category_rows(fname: str, set_name: str):
    ...
    print(pattern.format(f=fname))
    print(os.path.exists(pattern.format(f=fname)))
    reader = csv.reader(
        open(pattern.format(f=fname)), delimiter=";" #io.StringIO(request.content.decode("utf-8")), delimiter=";"
    )
