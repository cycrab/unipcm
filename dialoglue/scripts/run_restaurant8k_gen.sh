...
--train_data_path dialoglue/data_utils/dialoglue/restaurant8k/train.json \
...
--output_dir dialoglue/checkpoints/rest_10_ch11/ \
--train_batch_size 64 --dropout 0.1 --num_epochs 0 --learning_rate 3e-5 \
--model_name_or_path checkpoint11/epoch14 --task slot --do_lowercase --max_seq_length 100 --dump_outputs \
