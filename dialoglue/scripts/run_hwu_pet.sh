...
--output_dir dialoglue/checkpoints/hwu_10_pet_pretrain/ \
--pet_final dialoglue/pseudo_labels/pseudo_hwu.json \
--train_batch_size 64 --dropout 0.1 --num_epochs 30 --learning_rate 2e-5 \
--model_name_or_path checkpoint8/epoch19 --task intent --do_lowercase --max_seq_length 100 --dump_outputs \
